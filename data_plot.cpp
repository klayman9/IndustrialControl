...
{QwtPainter::setDeviceClipping(false);
 ...
 w_level = new QwtPlotCurve(QString::fromLocal8Bit("�������"));
 w_level->attach(this);
 ...
 setAxisTitle(QwtPlot::xBottom, QString::fromLocal8Bit("�����,�"));
 setAxisTitle(QwtPlot::yLeft, QString::fromLocal8Bit("�����������,�"));
 ...
 grid->attach(this);
#if 1
 QwtPlotCurve *desired_w = new QwtPlotCurve(QString::fromLocal8Bit("�������"));
 ...
 m1->attach(this);
 m2 = new QwtPlotMarker();
 m2->setLabel(QString::fromLocal8Bit("������ \"+\""));
...
/*====================================================================================================================*/
void DataPlot::view_desired(int desired_v) /* �������� �������� �������� */
{int i;
 mutex_0.lock();
 desired= desired_v;
 accuracy= 10.0;
...
/*====================================================================================================================*/
int DataPlot::get_cntrl_up_tm(void)                   /* �������� ����� ������ �� ������� */
{int i;
 if(!up_tm_holded)
	for (i = 0; i < (progress_tm -1); i++)
		{if(((int)d_y[i]) >= desired)                /* ���� ���������� �������� �� ����� ������ (�������-������) */
...
/*====================================================================================================================*/
int DataPlot::scan_extremp(int from)           		/* ������� ������� ����� ����������  */
{
    int t, h;
...
/*====================================================================================================================*/
int DataPlot::scan_extremn(int from)           		 							/* ������� ������� ����� ����������  */
{int t, h;
 for (t = from; t < (progress_tm -5); t++)
    {h= d_y[t+2];
...
/*====================================================================================================================*/
int DataPlot::get_signal_period(void)            /* �������� ������ ��������� */
{int i, tm;
 if(!(i= scan_extremp(0)))
	return 0;
...
/*====================================================================================================================*/
int DataPlot::get_signal_amplitude(void)              /* �������� ��������� ��������� ������� */
{int i, j, v;
/* if(!(i= scan_extremp(0)))
	return 0;*/
...
/*====================================================================================================================*/
int DataPlot::get_cntrl_err(void) {          /* �������� ������ ������������� */
